...
export const listings: Listing[] = [
  ...
  {
    slug: "pura-jungla-one-lot-32",
    title: {
      es: "Pura Jungla One — Lote #32",
      en: "Pura Jungla One — Lot #32",
    },
    description: {
      es: "Lote de 8 453 m² (más de 2 acres) dentro de Pura Jungla One — desarrollo residencial y reserva biológica en Playa Negra, Costa Dorada sur de Guanacaste. Vistas a la montaña, brisa desde todas las direcciones y 95 % del terreno utilizable, con una pequeña quebrada que atraviesa el sector oriental —potencial para lago estacional—.",
      en: "An 8,453 m² (over 2-acre) lot inside Pura Jungla One — a residential development and biological reserve in the Playa Negra area of Guanacaste's southern Gold Coast. Mountain views, breeze from every direction and 95% usable terrain, with a small gully crossing the eastern side — potential for a seasonal pond.",
    },
    price: 139000,
    currency: "USD",
    beds: null,
    ...
    status,
    photos: [
      "/properties/pura-jungla-one-lot-32/1.jpg",
      "/properties/pura-jungla-one-lot-32/2.jpg",
      "/properties/pura-jungla-one-lot-32/3.jpg",
    ],
    coverWidth: 1128,
    coverHeight: 762,
  },
  {
    slug: "pura-jungla-one-public-road-lot-32",
    title: {
      es: "Pura Jungla One — Lote #32 sobre calle pública",
      en: "Pura Jungla One — Public Road Lot #32",
    },
    description: {
      es: "Lote de 990 m² (20 metros de frente por 49,5 de fondo) sobre calle pública, frente a Pura Jungla One en Playa Negra. Zonificación mixta residencial/comercial, con servicios públicos de agua (ASADA local) y electricidad (Coopeguanacaste), carta de disponibilidad de agua vigente e internet de fibra óptica disponible.",
      en: "A 990 m² lot (20 m frontage × 49.5 m deep) on a public road, fronting Pura Jungla One in Playa Negra. Mixed residential/commercial zoning, with public water services (local ASADA) and electricity (Coopeguanacaste), a current will-serve water letter and fiber-optic internet available.",
    },
    price: 48000,
    currency: "USD",
    beds: null,
    ...
    status,
    photos: [
      "/properties/pura-jungla-one-public-road-lot-32/1.jpg",
      "/properties/pura-jungla-one-public-road-lot-32/2.jpg",
      "/properties/pura-jungla-one-public-road-lot-32/3.jpg",
      "/properties/pura-jungla-one-public-road-lot-32/4.jpg",
    ],
    coverWidth: 1132,
    coverHeight: 604,
  },
  {
    slug: "pura-jungla-two-1-5-ha-knoll",
    title: {
      es: "Vistas 360° al atardecer y a la montaña — 1,5 ha, Pura Jungla Two",
      en: "360° sunset & mountain views — 1.5 ha, Pura Jungla Two",
    },
    description: {
      es: "Colina de topografía única con vistas de 360°: océano, atardecer y montaña. Dos propiedades tituladas (A: 1 hectárea, B: 0,5 hectáreas) que se venden únicamente en conjunto. Zonificación de uso mixto —comercial y residencial— con 93 metros de frente sobre la carretera costera principal, servicios de agua y electricidad al frente, dos cartas de disponibilidad de agua vigentes hasta marzo de 2026 e internet de fibra óptica disponible. Financiamiento del vendedor por conversar.",
      en: "A hilltop with topography unique to the area and full 360-degree views: ocean, sunset and mountain. Two titled parcels (A: 1 hectare, B: 0.5 hectare) sold only together. Mixed-use commercial/residential zoning, with 93 meters of frontage on the main coastal road, water and electric services at the frontage, two valid will-serve water letters through March 2026, and fiber-optic internet available. Seller financing available — to be discussed.",
    },
    price: 490000,
    currency: "USD",
    beds: null,
    ...
    status,
    photos: [
      "/properties/pura-jungla-two-1-5-ha-knoll/1.jpg",
      "/properties/pura-jungla-two-1-5-ha-knoll/2.jpg",
      "/properties/pura-jungla-two-1-5-ha-knoll/3.jpg",
      "/properties/pura-jungla-two-1-5-ha-knoll/4.jpg",
      "/properties/pura-jungla-two-1-5-ha-knoll/5.jpg",
    ],
    coverWidth: 1151,
    coverHeight: 628,
  },
  {
    slug: "pura-jungla-two-46-5-ha",
    title: {
      es: "Pura Jungla Two — 46,5 hectáreas de tierra de desarrollo",
      en: "Pura Jungla Two — 46.5 hectares of prime development land",
    },
    description: {
      es: "Oportunidad de desarrollo o finca privada de 46,5 hectáreas (113 acres) en la Costa Dorada sur de Guanacaste, con aproximadamente 800 metros de frente a la carretera costera pública, 3 a 4 km de caminos internos y unos 700 metros de río estacional interno. Terreno de topografía suavemente ondulada, con muchos árboles grandes pero espaciados; alto porcentaje de tierra desarrollable. Zonificación de uso mixto sobre la calle pública y potencial de zonificación agrícola o de conservación en el interior — apta para condominio horizontal con manejo de conservación.",
      en: "A 46.5-hectare (113-acre) development or private-estate opportunity on Guanacaste's southern Gold Coast, with approximately 800 meters of frontage on the main public coastal road, 3–4 km of internal dirt roads and about 700 meters of internal seasonal river. Gently rolling terrain, with many large trees but spaced enough for low-density development; a high percentage of developable land. Mixed-use zoning on the public frontage and potential for agricultural or conservation zoning in the interior — well suited to a horizontal condominium with conservation management.",
    },
    price: 3220000,
    currency: "USD",
    beds: null,
    ...
    lotUnit: null,
    location: {
      es: "Costa Dorada sur, Guanacaste",
      en: "Southern Gold Coast, Guanacaste",
    },
    category: "land",
    status,
    photos: [
      "/properties/pura-jungla-two-46-5-ha/1.jpg",
      "/properties/pura-jungla-two-46-5-ha/2.jpg",
    ],
    coverWidth: 1600,
    coverHeight: 736,
  },
  {
    ...
    photos: [
      ...
      "/properties/pura-jungla-one-lots-5-6/7.jpg",
      "/properties/pura-jungla-one-lots-5-6/8.jpg",
      "/properties/pura-jungla-one-lots-5-6/9.jpg",
      "/properties/pura-jungla-one-lots-5-6/10.jpg",
      "/properties/pura-jungla-one-lots-5-6/11.jpg",
      "/properties/pura-jungla-one-lots-5-6/12.jpg",
      "/properties/pura-jungla-one-lots-5-6/13.jpg",
      "/properties/pura-jungla-one-lots-5-6/14.jpg",
    ],
    coverWidth: 1284,
    coverHeight: 707,
  },
